...
\newcommand{\benchmark}{\textsc{GeoClue}}

\jmlrheading{}{2026}{1-\pageref{LastPage}}{}{}{}{Ashok Sivathayalan and Sai Paladugu}
\usepackage{lastpage}

\ShortHeadings{GeoClue}{Sivathayalan and Paladugu}
\firstpageno{1}

\begin{document}

\title{GeoClue: A Cue-Structured Benchmark for Evaluating Geographic Visual Reasoning in Vision-Language Models}
...
\begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{example_linguistic.jpg}
    \caption{Linguistic (Thailand)}
    \label{fig:ex-ling}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{example_environmental.jpg}
    \caption{Environmental (Indonesia)}
    \label{fig:ex-env}
\end{subfigure}
\hfill
\begin{subfigure}[t]{0.32\textwidth}
    \centering
    \includegraphics[width=\textwidth]{example_infrastructure.jpg}
    \caption{Infrastructure (Finland)}
    \label{fig:ex-infra}
\end{subfigure}
\caption{Example images from \benchmark{}, one per cue type. (a)~Thai script on a government sign provides a linguistic cue. (b)~Tropical trees and brush provide an environmental cue (c)~Buildings and distinct road signs provide infrastructural information}
\label{fig:examples}
\end{figure}
...
\begin{table}[t]
\caption{Overall accuracy (\%) by model. Country and region columns use all 246 images; single-cue and multi-cue columns report country-level accuracy on each subset.}
\label{tab:overall}
\centering
\small
\begin{tabular}{lcccc}
\toprule
\textbf{Model} & \textbf{Country} & \textbf{Region} & \textbf{Single-Cue} & \textbf{Multi-Cue} \\
\midrule
Gemini 3 Flash     & 93.9 & 95.5 & 93.6 & 95.3 \\
Gemini 2.5 Flash   & 92.3 & 95.9 & 92.1 & 93.0 \\
Claude Sonnet 4.6  & 83.3 & 89.8 & 84.2 & 79.1 \\
GPT-4o-mini        & 81.3 & 89.4 & 79.3 & 90.7 \\
GPT-5.4-mini       & 75.2 & 85.0 & 75.4 & 74.4 \\
Claude Haiku 4.5   & 65.4 & 75.6 & 65.0 & 67.4 \\
\bottomrule
\end{tabular}
\end{table}
